...
def cifar_10():
  ...
  def run_ga():
    ...
    dataset = UncorrelatedSupervised(**{
      ...
      UncorrelatedSupervised.arg_NAME: 'CIFAR-10',
    ...
    model.add([
      ...
      LocalEH(**{LocalEH.arg_NN_FRAMEWORK: NVIDIATensorFlow(
        **{NVIDIATensorFlow.arg_DATA_SETS: [dataset],
           NVIDIATensorFlow.arg_TMP_FILE:
             dataDir + 'CIFAR-10/LAMARCK_log/state.ckpt',
      ...
      ModelStateSaverLoader(**{
        ...
        ModelStateSaverLoader.arg_FILE: dataDir + 'CIFAR-10/LAMARCK_log/model_state.pb',
      }),
      DSSqlite3(**{DSSqlite3.arg_FILE: dataDir + 'CIFAR-10/LAMARCK_log/history.db3'}),
      # TelegramNotifier(**{
